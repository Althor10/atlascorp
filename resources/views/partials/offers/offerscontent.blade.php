                                ...
                                <div class="offers_content">
                                    ...
                                    <div class="offers_icons">
                                        <ul class="offers_icons_list">
                                            @if($offer->wireless)
                                                <li class="offers_icons_item"><img src="images/wifi-2.png" alt="wifi"></li>
                                                @endif
                                            @if($offer->pool)
                                                <li class="offers_icons_item"><img src="images/pool.png" alt="pool"></li>
                                                @endif
                                            @if($offer->wheelchair)
                                                <li class="offers_icons_item"><img src="images/wheel.png" alt="invalid"></li>
                                                @endif
                                                @if($offer->smoking_area)
                                                    <li class="offers_icons_item"><img src="images/smoke.png" alt="smoke"></li>
                                                @endif
                                        </ul>
                                    </div>
