...
<div class="home">
    <div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/places/aboutus.jpg"></div>
...
<div class="intro">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <div class="intro_image"><img src="images/me.png" alt="Danilo Zdravkovic"></div>
            </div>
            <div class="col-lg-5">
                <div class="intro_content">
                    <div class="intro_title">danilo zdravković</div>
                    <p class="intro_text">Hi! My name is Danilo Zdravković and im a student at a ICT COLLEGE OF VOCATIONAL STUDIES in Belgrade. Big fan of books, games, languages, comics, photos, sports and many things more.
                        This is a project for our PHP class! No hotels, trips and travels are real, the cost and payment (reservation) is for show only! They are purely just for practicing of making a Laravel PHPwebsite.
                    </p>
                </br></br></br></br></br></br></br></br></br>
                    <div class="button intro_button"><span></span><span></span><span></span></div>
                </div>
            </div>
        </div>
    </div>
